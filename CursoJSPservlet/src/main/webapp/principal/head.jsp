<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <head>
    <title>Curso JSP - DEV Treinamentos </title>
    ...
    <!--[if lt IE 10]>
      ...
      <meta name="keywords" content="Pra botar as tags de procura" />
      <meta name="author" content="welligton" />
      <!-- Favicon icon -->
    ...
    <link rel="stylesheet" href="<%= request.getContextPath()%>/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
      ...
      <link rel="stylesheet" href="https://code.jquery.com/ui/1.9.1/themes/smoothness/jquery-ui.css" type="text/css" media="all" />

...
<nav class="pcoded-navbar">
	...
	<div class="pcoded-inner-navbar main-menu">
			...
			<div class="main-menu-content">
				<ul>
					<li class="more-details"><a href="user-profile.html">
							<!--   "!--<i class="ti-user"></i>View Profile</a> <a href="#!"><i -->
							<!-- class="ti-settings"></i>Settings</a> --> 
							<!-- "Controlador02?acao=Logout" -->
						<a href="<%=request.getContextPath()%>/Controlador02?acao=Logout">
		...
		<ul class="pcoded-item pcoded-left-item"> 
			<li class="active">
				 <a href="<%=request.getContextPath() %>/principal/principal.jsp" class="waves-effect waves-dark"> <span class="pcoded-micon"><i
			...
			<li class="pcoded-hasmenu">
				<a href="javascript:void(0)" class="waves-effect waves-dark" style="margin-top: 10px"> 
				...
				<!--   
					<li class=" "><a href="principal/teste.jsp"
						class="waves-effect waves-dark"> <span class="pcoded-micon"><i
								class="ti-angle-right"></i></span> <span class="pcoded-mtext"
							data-i18n="nav.basic-components.breadcrumbs">User</span> <span
							class="pcoded-mcaret"></span>
					</a></li>
		...
		<ul class="pcoded-item pcoded-left-item">
			<li>
				<a href="<%= request.getContextPath() %>\principal\reluser.jsp"
				class="waves-effect waves-dark"> <span class="pcoded-micon"><i
			...
			<li>
				<a href="<%= request.getContextPath() %>\principal\relusergrafico2.jsp"
				class="waves-effect waves-dark"> <span class="pcoded-micon"><i
						class="ti-layers"></i><b>FC</b></span> <span class="pcoded-mtext"
					data-i18n="nav.form-components.main">Membros ativos</span> <span
					class="pcoded-mcaret"></span>
				</a>
			</li>
			
			<li>
				<a href="<%= request.getContextPath() %>\principal\relusergrafico3.jsp"
				class="waves-effect waves-dark"> <span class="pcoded-micon"><i
						class="ti-layers"></i><b>FC</b></span> <span class="pcoded-mtext"
					data-i18n="nav.form-components.main">Informaçõe importantes</span> <span
					class="pcoded-mcaret"></span>
				</a>
			</li>
